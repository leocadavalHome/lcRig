...
larb= RibbonBezier(name='LarmBezier', size=larm.jointLength,numJnts=10, offsetStart=0.08, offsetEnd=0.1)
larb.doRig()
larb.connectToLimb(larm)
rarb= RibbonBezier(name='RarmBezier', size=rarm.jointLength,numJnts=10, offsetStart=0.1, offsetEnd=0.08)
rarb.doRig()
rarb.connectToLimb(rarm)

llrb= RibbonBezier(name='LlegBezier', size=lleg.jointLength, offsetStart=0.1, offsetEnd=0.1)
llrb.doRig()
llrb.connectToLimb(lleg)
rlrb= RibbonBezier(name='RlegBezier', size=lleg.jointLength ,offsetStart=0.1, offsetEnd=0.1)
rlrb.doRig()
